...
;!function (win, $, undefined) {
	var SVGMap = (function () {
		...
		SVGMap.prototype.options = {
			...
			mapWidth: 500,
			mapHeight: 400,
			stateColorList: ['2770B5', '429DD4', '5AABDA', 'dfdfdf', '70B3DD', 'C6E1F4', 'EDF2F6'],
			stateDataAttr: ['stateInitColor', 'stateHoverColor','stateHoverColor1', 'stateSelectedColor', 'baifenbi'],
			stateDataType: 'json',
			...
			stateInitColor: 'dfdfdf',
			stateHoverColor: 'e96a55',
			stateHoverColor1: '000',
			stateSelectedColor: 'e96a55',
